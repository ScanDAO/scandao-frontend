...
import LamboIcon from "../../../assets/icons/lambo.svg";
import ScanDAOIcon from "../../../assets/icons/scandao-nav-header.svg";
    ...
    return (
        <div className="dapp-sidebar">
            ...
            <div className="dapp-menu-links">
                <div className="dapp-nav">
                    ...
                    <div className="bond-discounts">
                        ...
                        {bonds.map((bond, i) => (
                            <Link component={NavLink} to={`/mints/${bond.name}`} key={i} className={"bond"}>
                                {!bond.bondDiscount ? (
                                    <Skeleton variant="text" width={"150px"} className="bond-discounts-skeleton" />
                                ) : (
                                    <p>
                                        {bond.displayName}
                    ...
                    <Link
                        ...
                        to="/wen-lambo"
                        isActive={(match: any, location: any) => {
                            return checkPage(location, "wen-lambo");
                        }}
                        className={classnames("button-dapp-menu", { active: isActive })}
                    >
                        <div className="dapp-menu-item">
            ...
            <div className="dapp-menu-doc-link">
                <Link href="https://ScanDAO.gitbook.io/ScanDAO/" target="_blank">
