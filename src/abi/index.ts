...
export { abi as WBNBBondContract } from "./bonds/WBNBContract.json";
...
export { abi as DalTokenContract } from "./tokens/DalContract.json";
export { abi as ScanTokenContract } from "./tokens/ScanContract..json";
