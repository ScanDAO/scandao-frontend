                ...
                <Box className="bond-data">
                    <div className="data-row">
                        ...
                        <p className="price-data bond-balance-title">
                            {isBondLoading ? <Skeleton width="100px" style={{ backgroundColor: "white" }} /> : `${trim(bond.interestDue, 4)} SCAN`}
                        </p>
                    </div>
                    <div className="data-row">
                        <p className="bond-balance-title">Claimable Rewards</p>
                        <p className="price-data bond-balance-title">
                            {isBondLoading ? <Skeleton width="100px" style={{ backgroundColor: "white" }} /> : `${trim(bond.pendingPayout, 4)} SCAN`}
                        </p>
                    </div>
                    <div className="data-row">
                        <p className="bond-balance-title">Time until fully vested</p>
                        <p className="price-data bond-balance-title">{isBondLoading ? <Skeleton width="100px" style={{ backgroundColor: "white" }} /> : vestingTime()}</p>
                    </div>
