                ...
                <Box className="bond-data">
                    <div className="data-row">
                        ...
                        <p className="bond-balance-title">
                            {isBondLoading ? (
                                <Skeleton width="100px" style={{ backgroundColor: "white" }} />
                            ) : (
                                <>
                    ...
                    <div className="data-row">
                        ...
                        <p className="price-data bond-balance-title">
                            {isBondLoading ? <Skeleton width="100px" style={{ backgroundColor: "white" }} /> : `${trim(bond.bondQuote, 4)} SCAN`}
                        </p>
                    </div>
                    ...
                    <div className={`data-row`}>
                        ...
                        <p className="price-data bond-balance-title">
                            {isBondLoading ? <Skeleton width="100px" style={{ backgroundColor: "white" }} /> : `${trim(bond.maxBondPrice, 4)} SCAN`}
                        </p>
                    </div>
                    ...
                    <div className="data-row">
                        ...
                        <p className="bond-balance-title">
                            {isBondLoading ? <Skeleton width="100px" style={{ backgroundColor: "white" }} /> : `${trim(bond.bondDiscount * 100, 2)}%`}
                        </p>
                    </div>

                    <div className="data-row">
                        <p className="bond-balance-title">Vesting Term</p>
                        <p className="bond-balance-title">{isBondLoading ? <Skeleton width="100px" style={{ backgroundColor: "white" }} /> : vestingPeriod()}</p>
                    </div>

                    <div className="data-row">
                        <p className="bond-balance-title">Minimum purchase</p>
                        <p className="bond-balance-title">0.01 SCAN</p>
                    </div>

                    {recipientAddress !== address && (
                        <div className="data-row">
                            <p className="bond-balance-title">Recipient</p>
                            <p className="bond-balance-title">{isBondLoading ? <Skeleton width="100px" style={{ backgroundColor: "white" }} /> : shorten(recipientAddress)}</p>
                        </div>
                    )}
                </Box>
            </Slide>
