...
import { bnb, busd } from "../../../helpers/tokens";
...
function Zapin({ open, handleClose, bond }: IZapinProps) {
    ...
    if (bond.name === wbnb.name) {
        defaultToken = tokens.find(token => token.name === busd.name);
    }
    ...
    const setMax = () => {
        ...
        let amount: any = Math.min(maxBondPriceToken, token.isBnb ? token.balance * 0.99 : token.balance);
                        ...
                        <div className="zapin-body-params">
                            ...
                            <div className="data-row">
                                ...
                                <p className="data-row-value">
                                    {isLoading ? <Skeleton width="100px" style={{ backgroundColor: "white" }} /> : `${minimumReceivedAmount} ${bond.displayUnits}`}
                                </p>
                            </div>
                            <div className="data-row">
                                <p className="data-row-name">Approximately you will get</p>
                                <p className="data-row-value">
                                    {isLoading ? <Skeleton width="100px" style={{ backgroundColor: "white" }} /> : `~ ${trim(bond.bondQuote, 4)} SCAN`}
                                </p>
                            </div>
                            <div className="data-row">
                                <p className="data-row-name">Max You Can Buy</p>
                                <p className="data-row-value">
                                    {isLoading ? <Skeleton width="100px" style={{ backgroundColor: "white" }} /> : `${trim(bond.maxBondPrice, 4)} SCAN`}
                                </p>
                            </div>
                            <div className="data-row">
                                <p className="data-row-name">ROI</p>
                                <p className="data-row-value">
                                    {isLoading ? <Skeleton width="100px" style={{ backgroundColor: "white" }} /> : `${trim(bond.bondDiscount * 100, 2)}%`}
                                </p>
                            </div>
                            <div className="data-row">
                                <p className="data-row-name">Minimum purchase</p>
                                <p className="data-row-value">0.01 SCAN</p>
                            </div>
