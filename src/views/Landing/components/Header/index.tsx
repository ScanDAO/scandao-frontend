...
import "./header.scss";
import { ReactComponent as ScanDAOIcon } from "../../../../assets/icons/scandao-icon.svg";
...
function Header() {
    ...
    return (
        <div className="landing-header">
            <SvgIcon color="primary" component={ScanDAOIcon} viewBox="0 0 174 40" style={{ minWidth: 174, minHeight: 40 }} />
