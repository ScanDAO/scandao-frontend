            ...
            <Paper className="bond-data-card">
                ...
                <div className="data-row">
                    ...
                    <p className="bond-price bond-name-title">
                        <>
                            {priceUnits(bond)} {isBondLoading ? <Skeleton width="50px" className="bond-skeleton" /> : trim(bond.bondPrice, 2)}
                        </>
                    </p>
                </div>
                ...
                <div className="data-row">
                    ...
                    <p className="bond-name-title">{isBondLoading ? <Skeleton width="50px" className="bond-skeleton" /> : `${trim(bond.bondDiscount * 100, 2)}%`}</p>
                </div>
    ...
    return (
        <TableRow>
            ...
            <TableCell align="center">
                <p className="bond-name-title">
                    <>
                        <span className="currency-icon">{priceUnits(bond)}</span> {isBondLoading ? <Skeleton width="50px" className="bond-skeleton" /> : trim(bond.bondPrice, 2)}
                    </>
                </p>
            </TableCell>
            ...
            <TableCell align="right">
                <p className="bond-name-title">
                    {isBondLoading ? (
                        <Skeleton width="50px" className="bond-skeleton" />
                    ) : (
                        new Intl.NumberFormat("en-US", {
                            style: "currency",
                            currency: "USD",
