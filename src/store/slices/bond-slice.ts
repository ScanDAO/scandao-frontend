...
import { bnbScan, wbnb } from "../../helpers/bond";
...
export const bondAsset = createAsyncThunk("bonding/bondAsset", async ({ value, address, bond, networkID, provider, slippage, useBnb }: IBondAsset, { dispatch }) => {
